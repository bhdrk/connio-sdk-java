 ...
 * @see <a href="https://github.com/jhalterman/typetools">https://github.com/jhalterman/typetools</a>
 */
public final class TypeResolver {
     ...
     * the {@code subType} else {@link com.connio.sdk.http.utils.TypeResolver.Unknown} if the raw class cannot be resolved.
     *
     * @param genericType to resolve raw class for
     * @param subType     to extract type variable information from
     * @return raw class for the {@code genericType} else {@link com.connio.sdk.http.utils.TypeResolver.Unknown} if it cannot be resolved
     */
