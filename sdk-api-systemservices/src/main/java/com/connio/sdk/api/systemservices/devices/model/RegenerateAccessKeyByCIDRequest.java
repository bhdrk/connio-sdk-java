 ...
 * @since 29.09.2014
 */
public class RegenerateAccessKeyByCIDRequest extends DeviceRequest<RegenerateAccessKeyResponse> {
    @Override
    ...
    public RegenerateAccessKeyByCIDRequest() {
    }

    public RegenerateAccessKeyByCIDRequest(Cid deviceCid) {
