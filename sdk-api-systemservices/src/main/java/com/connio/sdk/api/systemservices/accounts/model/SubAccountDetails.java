...
public class SubAccountDetails implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SubAccountDetails that = (SubAccountDetails) o;
        ...
        if (ownerAccountSid != null ? !ownerAccountSid.equals(that.ownerAccountSid) : that.ownerAccountSid != null)
            return false;
        if (planType != that.planType) return false;
        if (sid != null ? !sid.equals(that.sid) : that.sid != null) return false;
        if (status != that.status) return false;
        if (uri != null ? !uri.equals(that.uri) : that.uri != null) return false;
        if (usersUri != null ? !usersUri.equals(that.usersUri) : that.usersUri != null) return false;
    ...
    @Override
    public int hashCode() {
        int result = ownerAccountSid != null ? ownerAccountSid.hashCode() : 0;
        ...
        result = 31 * result + (usersUri != null ? usersUri.hashCode() : 0);
